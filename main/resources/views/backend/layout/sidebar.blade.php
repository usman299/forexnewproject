...
{{--            @endif--}}
            ...
            @if (auth()->guard('admin')->user()->can('manage-referral'))
                <li><a href="{{ route('admin.refferal.index') }}" aria-expanded="false"><i
                            data-feather="link"></i><span class="nav-text">{{ __('Manage Levels') }}</span></a>
                </li>
            @endif

            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        data-feather="credit-card"></i><span class="nav-text">{{ __('Manage P2P') }}</span></a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('admin.metamask.ptop') }}">{{ __('Metamask P2P') }}</a></li>
                    <li><a href="{{ route('admin.admin.ptop') }}">{{ __('Admin P2P') }}</a></li>
                    <li><a href="{{ route('admin.ptop') }}">{{ __('Manage Internal P2P') }}</a></li>

                </ul>
            </li>
            <li><a href="{{ route('admin.percentage') }}" aria-expanded="false"><i data-feather="link"></i><span class="nav-text">{{ __('Add Percentage') }}</span></a>
                                    </li>
...
{{--            @if (auth()->guard('admin')->user()->can('manage-email'))--}}
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i data-feather="mail"></i><span
                            class="nav-text">{{ __('Config') }}</span></a>
                    <ul aria-expanded="false">

                        @if(auth()->guard('admin')->user()->id === 1)
                        <li><a href="{{ route('admin.email.config') }}">{{ __('Email Configure') }}</a></li>
                        @endif
                        <li><a href="{{ route('admin.section.manage') }}">{{ __('OverView Section') }}</a></li>
