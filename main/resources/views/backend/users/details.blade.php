...
{{--                    </div>--}}
                    ...
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"> {{ Config::formatter($user->ptop)}}</h4>
                                <p>{{ __('Total P2P Amount') }}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1">{{ Config::formatter($user->ttx)}}</h4>
                                <p>{{ __('Received  Reward') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1">{{ Config::formatter($user->tx)}} </h4>
                                <p>{{ __('Maximum Reward') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1">{{ Config::formatter($user->ttx - $user->tttx)}} </h4>
                                <p>{{ __('Current Available  Reward') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3">
            <div class="p-4 bg-white rounded-lg total-balance">
                ...
                <div class="text-center mt-3">
                    <div class="balance">{{ __('Total Balance') }}</div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header dates">
                    <h5 class="mb-0">{{ __('Transaction Reference') }}</h5>
...
{{--                                    <th>{{ __('Sender Unique ID') }}</th>--}}
                                ...
                                @forelse($transactions as $key => $transaction)
                                    <tr>
                                        ...
                                        <td data-caption="{{ __('Unique ID') }}">
                                            {{ optional($transaction->user)->username }}</td>
{{--                                        <?php--}}
{{--                                        $userrr = \App\Models\User::where('id',$transaction->rec_id)->first();--}}
{{--                                        ?>--}}
{{--                                        @if($userrr)--}}
{{--                                        <td data-caption="{{ __('Sender Unique ID') }}">--}}
{{--                                            {{ $userrr->username }}</td>--}}
{{--                                        @else--}}
{{--                                            <td data-caption="{{ __('Sender Unique ID') }}">--}}
{{--                                               - </td>--}}
{{--                                        @endif--}}
                                        ...
                                        <td data-caption="{{ __('Charge') }}">
                                            {{ Config::formatter($transaction->charge) }}</td>
                    ...
                    <div class="card-footer">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                @else
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $transactions->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                                    </li>
                                @endif
                                ...
                                @if ($transactions->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $transactions->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                                    </li>
                                @else
