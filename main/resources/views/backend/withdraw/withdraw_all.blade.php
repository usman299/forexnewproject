                            ...
                            <tbody id="filter_data">
                                @forelse ($data['withdraws'] as $key => $withdrawlog)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $withdrawlog->created_at->format('d, M Y H:i:s') }}
                                        </td>
                                        ...
                                        <td id="copyText{{ $key }}">{{ $withdrawlog->proof }}</td>
                                        <td>
            ...
            $(document).on('click','.details' ,function() {
                ...
                let html = `
                    ...
                    <ul class="list-group">
                            ...
                            {{--    <span>${$(this).data('reject_reason')}</span>--}}
                            {{--</li>--}}
