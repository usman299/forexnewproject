...
{{--                </div>--}}
                <div class="col-lg-6 col-sm-6">
                    <div class="card mb-4 gr-white gr-white2 rounded-xl link-item widget-hr-effect">
                        <a href="{{ route('admin.deposit', 'online') }}" class="link"></a>
                        <div class="sp-widget-2 card-body">
                            <a href="{{ route('admin.deposit', 'online') }}" class="widget-link-arrow"><i
                                    class="las la-arrow-right"></i></a>
                            <div class="top">
                                <div class="widget-icon">
                        ...
                        <div class="sp-widget-2 card-body">
                            ...
                            <div class="bottom mt-3">
                                <div class="widget-content">
                                    ...
                                    @endphp
                                    <h2 class="mb-0">{{ Config::formatter($withdraw) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="card mb-4 gr-white gr-white2 rounded-xl link-item widget-hr-effect">
                        <a href="{{ route('admin.metamask.ptop') }}" class="link"></a>
                        <div class="sp-widget-2 card-body">
                            <a href="{{ route('admin.metamask.ptop') }}" class="widget-link-arrow"><i
                                    class="las la-arrow-right"></i></a>
                            <div class="top">
                                <div class="widget-icon">
                                    <i class="las la-hourglass-half"></i>
                                ...
                                <div class="widget-content">
                                    <h5 class="mb-0">{{ __('Total Metamask P2P') }}</h5>
                                </div>
                            </div>
                            <div class="bottom mt-3">
                                <div class="widget-content">
                                    <h2 class="mb-0">{{ Config::formatter($metamask_ptop) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="card mb-4 gr-white gr-white2 rounded-xl link-item widget-hr-effect">
                        <a href="{{ route('admin.admin.ptop') }}" class="link"></a>
                        <div class="sp-widget-2 card-body">
                            <a href="{{ route('admin.admin.ptop') }}" class="widget-link-arrow"><i
                                    class="las la-arrow-right"></i></a>
                            <div class="top">
                                <div class="widget-icon">
                                    <i class="las la-hourglass-half"></i>
                                ...
                                <div class="widget-content">
                                    <h5 class="mb-0">{{ __('Total Admin P2P') }}</h5>
                                </div>
                            </div>
                            <div class="bottom mt-3">
                                <div class="widget-content">
                                    <h2 class="mb-0">{{ Config::formatter($admin_ptop) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="card mb-4 gr-white gr-white2 rounded-xl link-item widget-hr-effect">
                        <a href="{{ route('admin.ptop') }}" class="link"></a>
                        <div class="sp-widget-2 card-body">
                            <a href="{{ route('admin.ptop') }}" class="widget-link-arrow"><i
                                    class="las la-arrow-right"></i></a>
                            <div class="top">
                                <div class="widget-icon">
                                    <i class="las la-hourglass-half"></i>
                                ...
                                <div class="widget-content">
                                    <h5 class="mb-0">{{ __('Total Internal P2P') }}</h5>
                                </div>
                            </div>
                            <div class="bottom mt-3">
                                <div class="widget-content">
                                    <h2 class="mb-0">{{ Config::formatter($ptop) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
