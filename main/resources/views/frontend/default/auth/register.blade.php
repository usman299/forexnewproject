...
{{--            @if (isset(request()->reffer))--}}
            ...
            <div class="col-md-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text"    class="form-control value="{{ old('username2') }}" @error('username2', 'registration')  is-invalid @enderror" name="username2" value="{{ old('username2') }}" placeholder="{{ __('Username') }}" >
                    <i class="las la-user"></i>
                    @error('username2', 'registration')
...
{{--        @endif--}}
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text" required class="form-control " name="first_name" value="{{ old('first_name') }}" id="first_name" placeholder="{{ __('First  Name') }}">
                    <i class="las la-user"></i>
                </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text" required class="form-control"
                           name="last_name" value="{{ old('last_name') }}" id="last_name" placeholder="{{ __('Last  Name') }}">
                    <i class="las la-user"></i>
                </div>
            </div>
                <?php
                ...
                ?>
            <div class="col-sm-12">
                <label>{{ __(' Unique ID (generated by Company)') }}</label>
                <div class="sp_input_icon_field mb-3">
                    <input type="text" class="form-control @error('username', 'registration')  is-invalid @enderror"
                        name="username" value="{{ $randomNumber }}"  readonly id="username" placeholder="{{ __('User Name') }}">
                    <i class="las la-user"></i>
            ...
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="number" value="{{ old('phone') }}" class="form-control @error('phone', 'registration')  is-invalid @enderror"
