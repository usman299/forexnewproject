...
{{--                class="btn sp_theme_btn btn-sm">{{ __('Home') }}</a>--}}
            <?php
            $u = auth()->user();
            ...
            <a type="button" target="_blank" href="#"
               class="btn sp_theme_btn btn-sm">{{ __('InActive') }}</a>
            @else
                <a type="button" target="_blank" href="#"
                   class="btn sp_theme_btn btn-sm">{{ __('Active') }}</a>
            @endif
