...
{{--                        <li><a href="mailto:'dotcoinverse@gmail.com'"><i class="fas fa-envelope"></i>--}}
{{--                               dotcoinverse@gmail.com</a></li>--}}
...
{{--                                <a href="{{ route('user.logout') }}" class="btn sp_theme_btn btn-sm">{{ __('Logout') }}--}}
