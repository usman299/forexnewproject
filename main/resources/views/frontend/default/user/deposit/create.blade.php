...
{{--                        <span class="text-white">{{ Config::formatter(auth()->user()->txx)}}</span></p>--}}
                </div>
                <div class="card-body">
                    <form action="">
                        ...
                        <button type="button" id="install" onclick="initiateTransfer()" class="btn sp_theme_btn w-100"  >{{ __('Deposit Money via Metamask') }}</button>

{{--                                                <button type="button" id="myButtonvv"  class="btn sp_theme_btn w-100"  >{{ __('Deposit Money via Metamask') }}</button>--}}

                        <a  onclick="message()" id="notInstall"  class="btn sp_theme_btn w-100"  >{{ __('Deposit Money via Metamask') }}</a>

                        <p style="margin-top: 10px" class="text-center mb-3">{{ __('Go to your metamask wallet, open your account into browser connect it and deposit amount through USDT (bep20) by using BNB Network') }}
                        </p>
                    </form>
                </div>
