    ...
    <div class="row gy-4 user-team-row">
                    ...
                    <div class="pricing-header">
                        ...
                        <div class="right">
                            ...
                            <h5 class="package-price">
                                {{'$ '. number_format($staking + 5,2) }}
                            </h5>
                            @else
                                <h5 class="package-price">
                                    {{'$ '. number_format($staking,2) }}
                                </h5>
                            @endif
                        </div>
                    </div>
                ...
                <div class="pricing-header">
                    ...
                    <div class="right">
                        <h5 class="package-price">
                            ...
                            {{'$ '. number_format($available_reward,2)}}
                        </h5>
                    </div>
                </div>
                <div class="pricing-body">
            ...
            <div class="sp_pricing_item">
                <div class="pricing-header">
                    ...
                    <div class="right">
                        <h5 class="package-price">
                            {{'$ '.number_format($maximum_reward,2)}}
                        </h5>
                    </div>
                </div>
                <div class="pricing-body">
             ...
             <div class="col-lg-3">
                 <div class="sp_pricing_item">
                     <div id="chart"></div>
{{--                     <div class="pricing-body">--}}
{{--                         <a href="{{route('user.transection')}}" data-id=""--}}
{{--                            class="btn sp_theme_btn w-100 chooseBtn">{{ __('Statement Details') }}--}}
{{--                         </a>--}}
{{--                     </div>--}}
                 </div>
             </div>
...
<script>
    var receive_reward = @json($available_reward);
    var maximum_reward = @json($maximum_reward);
