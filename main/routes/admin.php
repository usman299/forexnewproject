...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin', 'demo'])->group(function () {
        ...
        Route::get('percentage', [AdminProfileController::class, 'percentage'])->name('percentage');
        Route::post('percentage', [AdminProfileController::class, 'percentageStore'])->name('percentage.store');
        Route::post('percentage/delete', [AdminProfileController::class, 'percentageDelete'])->name('percentage.delete');
        Route::get('metamask/ptop', [AdminProfileController::class, 'metamaskPtop'])->name('metamask.ptop');
        Route::get('admin/ptop', [AdminProfileController::class, 'adminPtop'])->name('admin.ptop');
        Route::get('ptop', [AdminProfileController::class, 'Ptop'])->name('ptop');
        ...
        Route::get('manage/section', [ManageSectionController::class, 'overviewSection'])->name('section.manage');
