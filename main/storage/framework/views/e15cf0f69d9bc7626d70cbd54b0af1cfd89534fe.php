                    ...
                    <div class="sp_blog_item">
                        ...
                        <div class="sp_blog_content">
                            ...
                            <h4 class="sp_blog_title"><a
                                    href="<?php echo e(route('blog.details', [$blog->id, Str::slug($blog->content->blog_title)])); ?>">

                                    <?php echo e($blog->content->blog_title); ?>
...
<!-- blog section end -->
<?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/widgets/blog.blade.php ENDPATH**/ ?>