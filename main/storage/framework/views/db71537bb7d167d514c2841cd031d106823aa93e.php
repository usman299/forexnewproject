    ...
    <div class="col-xxl-4 col-xl-6 col-lg-4 col-6">
        <div class="neo-card neo-card-1">
            ...
            <h4 class="neo-amount">
                ...
                <?php else: ?>
                    <?php echo e(Config::formatter($staking_amount)); ?>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/user/dashboard.blade.php ENDPATH**/ ?>