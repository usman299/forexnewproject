...
<?php $__env->startSection('element'); ?>
    ...
    <div class="row gy-4">
        <div class="col-lg-9">
            <div class="p-4 bg-white rounded-lg  user-detail">
                ...
                <div class="row pb-1">
                    ...
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            <div class="sp-user-box_icon gr-bg-3">
                                <i class="las la-dollar-sign"></i>
                            </div>
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"> <?php echo e(Config::formatter($user->ptop)); ?></h4>
                                <p><?php echo e(__('Total P2P Amount')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-sm-0 mb-4">
                        <div class="sp-user-box">
                ...
                <div class="row mt-2">
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"><?php echo e(Config::formatter($user->ttx)); ?></h4>
                                <p><?php echo e(__('Received  Reward')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"><?php echo e(Config::formatter($user->tx)); ?> </h4>
                                <p><?php echo e(__('Maximum Reward')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 col-md-4 col-sm-6 mb-xxl-0 mb-4">
                        <div class="sp-user-box">
                            ...
                            <div class="sp-user-box_content">
                                <h4 class="mb-1"><?php echo e(Config::formatter($user->ttx - $user->tttx)); ?> </h4>
                                <p><?php echo e(__('Current Available  Reward')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="p-4 mt-4 bg-white rounded-lg profile-setting">
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" <?php echo e($user->is_email_verified ? 'checked' : ''); ?> name="email_status"
                                ...
                                <div class="col-xl-3 col-6 mb-2">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label"
                                            for="useCheck4"><?php echo e(__('Status')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-3">
            <div class="p-4 bg-white rounded-lg total-balance">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="addBalance" class="mt-3">
                    <?php echo csrf_field(); ?>
                ...
                <form action="<?php echo e(route('admin.user.balance.update', $user->id)); ?>" method="post" id="subBalance" class="mt-3">
                    <?php echo csrf_field(); ?>
                    <div class="input-group mb-3">
                        <input type="hidden" class="form-control" name="user_id" value="<?php echo e($user->id); ?>">
            ...
            <div class="mt-4 p-4 bg-white rounded-lg quick-links">
                ...
                <ul class="user-action-list pb-2">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.deposit.log', $user)); ?>" class="user-action-btn">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.withdraw.report', $user)); ?>" class="user-action-btn">
                            <i class="fas fa-file-alt mr-2"></i>
                            <?php echo e(__('Withdraw Log')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.transaction', $user)); ?>" class="user-action-btn">
                            <i class="fas fa-exchange-alt mr-2"></i>
                            <?php echo e(__('User Transactions')); ?>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header dates">
                    <h5 class="mb-0"><?php echo e(__('Transaction Reference')); ?></h5>
                ...
                <div class="card-body">
                            ...
                            <table class="table sp_site_table">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td data-caption="<?php echo e(__('Unique ID')); ?>">
                                        ...
                                        <td data-caption="<?php echo e(__('Charge')); ?>">
                                            <?php echo e(Config::formatter($transaction->charge)); ?></td>
                    ...
                    <?php else: ?>
                        <div class="col-md-12 text-center mt-5">
                            ...
                            <p class="mt-2">
                                <?php echo e(__('No User Transaction  Found')); ?>
                    ...
                    <div class="card-footer">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                <?php else: ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo e($transactions->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">&lsaquo;</a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $transactions->getUrlRange(1, $transactions->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php elseif($page >= $transactions->currentPage() - 2 && $page <= $transactions->currentPage() + 2): ?>
                                        <li class="page-item"><a class="page-link" href="<?php echo e($url); ?>"><?php echo e($page); ?></a></li>
                                    <?php elseif($page == $transactions->currentPage() - 3 || $page == $transactions->currentPage() + 3): ?>
                                ...
                                <?php if($transactions->hasMorePages()): ?>
                                    <li class="page-item">
                                        <a class="page-link" href="<?php echo e($transactions->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>">&rsaquo;</a>
                                    </li>
                                <?php else: ?>
                                                    ...
                                                    <li class="single-child">
                                                        ...
                                                        <ul class="sub-child-list step-4">
                                                            <?php $__currentLoopData = $ref->refferals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li class="single-child">
                                                                    <p>
                                                                        <img src="<?php echo e(Config::getFile('user', $ref2->image)); ?>">
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/users/details.blade.php ENDPATH**/ ?>