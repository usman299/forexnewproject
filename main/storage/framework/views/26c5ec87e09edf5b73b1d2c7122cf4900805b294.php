                    ...
                    <div class="table-responsive">
                        <table class="table student-data-table m-t-20">
                            ...
                            <tr>
                                ...
                                <th><?php echo e(__('Sender Address')); ?></th>
                                <th><?php echo e(__('Receiver Address')); ?></th>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $profit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <?php if($metamask): ?>
                                    <td><?php echo e($metamask->trx ?? '-'); ?></td>
                                    <td><?php echo e($metamask->user_address); ?> </td>
                                    <td><?php echo e($metamask->admin_address); ?></td>
                                    <?php else: ?>
                                        <td>-</td>
                                        <td>-</td>
                                        <td>-</td>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/withdraw/ptop.blade.php ENDPATH**/ ?>