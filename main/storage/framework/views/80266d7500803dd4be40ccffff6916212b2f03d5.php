...
<section class="sp_banner" style="background-image: url('<?php echo e(Config::getFile('banner', $banner->content->image_two ?? '')); ?>');">

    <div class="sp_banner_el">
        <img src="<?php echo e(Config::getFile('banner', $banner->content->image_one)); ?>" alt="banner image">
    </div>
    ...
    <div class="container">
        <div class="row gy-5 justify-content-lg-between justify-content-center align-items-center">
            <div class="col-lg-7 text-lg-start text-center">
                ...
                <p class="sp_banner_description"><?php echo e(Config::trans($banner->content->description)); ?></p>
            ...
            <div class="col-lg-5 col-md-6 col-sm-7">
                <div class="sp_banner_thumb wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.9s">
                    <img src="<?php echo e(Config::getFile('banner', $banner->content->image_three)); ?>" alt="banner image">
                </div>
            </div>
        </div>
    </div>
</section>
<!-- banner section end --><?php /**PATH C:\xampp\htdocs\forexxx\main\resources\views/frontend/light/widgets/banner.blade.php ENDPATH**/ ?>