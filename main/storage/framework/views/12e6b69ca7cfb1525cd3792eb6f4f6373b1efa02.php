                            ...
                            <tbody id="filter_data">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(optional($transaction->withdrawMethod)->name); ?></td>
                                        <td><?php echo e(Config::formatter($transaction->withdraw_amount)); ?></td>
                                        <td><?php echo e(Config::formatter($transaction->withdraw_charge)); ?></td>
        ...
        $(function() {
            ...
            $('.ranges ul li').each(function(index) {
                $(this).on('click', function() {
                    ...
                    $("#overlay").fadeIn(300);
                    $.ajax({
                        url: "<?php echo e(route('admin.withdraw.report')); ?>",
                        data: {
                            key: key
                        },
                        method: "GET",
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/logs/withdraw_report.blade.php ENDPATH**/ ?>