                        ...
                        <table class="table student-data-table m-t-20">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(__('Trx Address')); ?></th>
                            ...
                            <tbody id="filter_data">
                                <?php $__empty_1 = true; $__currentLoopData = $data['withdraws']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $withdrawlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($withdrawlog->created_at->format('d, M Y H:i:s')); ?>
                                        ...
                                        <td id="copyText<?php echo e($key); ?>"><?php echo e($withdrawlog->proof); ?></td>
                                        <td>
           ...
           $('[id^="copyText"]').click(function() {
               ...
               if(textToCopy){
                   Swal.fire({
                       position: "top-end",
                       icon: "success",
                       title: "Address Copied Successfully  "+textToCopy,
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/withdraw/withdraw_all.blade.php ENDPATH**/ ?>