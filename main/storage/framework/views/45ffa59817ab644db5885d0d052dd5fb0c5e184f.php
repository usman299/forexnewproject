                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration="0.3s">
                    <div class="sp_choose_item">
                        <div class="sp_choose_icon">
                            <img src="<?php echo e(Config::getFile('why_choose_us', $el->content->image_one)); ?>" alt="">
                            <i class="<?php echo e($el->content->icon); ?>"></i>
                        </div>
                        <div class="sp_choose_content">
                            <h4 class="title"><?php echo e(Config::trans($el->content->title)); ?></h4>
                            <p class="mt-3">

                            <?php echo e($el->content->description); ?>
...
<?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/widgets/why_choose_us.blade.php ENDPATH**/ ?>