        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-header justify-content-end">
                    <a href="<?php echo e(route('admin.frontend.section.manage', request()->name)); ?>" class="btn btn-primary m-3"> <i
                            class="fas fa-arrow-left"></i> <?php echo e(__('Go back')); ?></a>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" action="" enctype="multipart/form-data" class="repeater">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary float-right"><?php echo e(__('Create')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\forexxx\main\resources\views/backend/frontend/element.blade.php ENDPATH**/ ?>