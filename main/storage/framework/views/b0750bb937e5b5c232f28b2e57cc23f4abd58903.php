            ...
            <div class="sp_site_card">
                ...
                <div class="card-body">
                    <form id="depositForm"  action="<?php echo e(route('user.deposit.store.submit')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <p class="text-center mb-3"><?php echo e(__('Minimum deposit amount 25 USDT')); ?>
...
<?php echo $__env->make(Config::theme(). 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/user/deposit/create2.blade.php ENDPATH**/ ?>