...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('user.register')); ?>" method="POST" >
        ...
        <div class="row">
                ...
                <div class="col-md-6">
                    <label><?php echo e(__('Referred By (Optional)')); ?></label>
                    <div class="sp_input_icon_field mb-3">
                        <input type="text"    class="form-control sp_bg_dark" value="<?php echo e(request()->reffer); ?>" name="reffered_by"
                            placeholder="<?php echo e(__('Referred By')); ?>" >
            ...
            <div class="col-md-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text"    class="form-control value="<?php echo e(old('username2')); ?>" <?php $__errorArgs = ['username2', 'registration'];
...
unset($__errorArgs, $__bag); ?>" name="username2" value="<?php echo e(old('username2')); ?>" placeholder="<?php echo e(__('Username')); ?>" >
                    <i class="las la-user"></i>
                    <?php $__errorArgs = ['username2', 'registration'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text" required class="form-control " name="first_name" value="<?php echo e(old('first_name')); ?>" id="first_name" placeholder="<?php echo e(__('First  Name')); ?>">
                    <i class="las la-user"></i>
                </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="text" required class="form-control"
                           name="last_name" value="<?php echo e(old('last_name')); ?>" id="last_name" placeholder="<?php echo e(__('Last  Name')); ?>">
                    <i class="las la-user"></i>
                </div>
            </div>
                <?php
                ...
                ?>
            <div class="col-sm-12">
                <label><?php echo e(__(' Unique ID (generated by Company)')); ?></label>
                <div class="sp_input_icon_field mb-3">
...
unset($__errorArgs, $__bag); ?>"
                        name="username" value="<?php echo e($randomNumber); ?>"  readonly id="username" placeholder="<?php echo e(__('User Name')); ?>">
                    <i class="las la-user"></i>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <select name="code" id="" class="form-select">
                            ...
                            <option data-countryCode="PKR" value="92">Pakistan (+92)</option>
            ...
            <div class="col-sm-6">
                ...
                <div class="sp_input_icon_field mb-3">
                    <input type="number" value="<?php echo e(old('phone')); ?>" class="form-control <?php $__errorArgs = ['phone', 'registration'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php echo $__env->make(Config::theme() . 'auth.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/auth/register.blade.php ENDPATH**/ ?>