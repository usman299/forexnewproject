                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $withdrawlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $withdrawlog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td data-caption="<?php echo e(__('Withdraw Amount')); ?>">
                                            <?php echo e(number_format($withdrawlog->withdraw_amount, 2)); ?>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(number_format($withdrawlog->total, 2)); ?>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\forexxx\main\resources\views/frontend/default/user/withdraw/withdraw_log.blade.php ENDPATH**/ ?>