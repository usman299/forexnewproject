...
<div class="cursor2"></div>
    ...
    <header class="user-header">
        ...
        <div class="dropdown user-dropdown">
            ...
            <?php
            $u = auth()->user();
            $dep = \App\Models\Deposit::where('user_id',$u->id)->count();
            ?>
            <?php if($dep==0 || $u->tx === $u->ttx ): ?>
            <a type="button" target="_blank" href="#"
               class="btn sp_theme_btn btn-sm"><?php echo e(__('InActive')); ?></a>
            <?php else: ?>
                <a type="button" target="_blank" href="#"
                   class="btn sp_theme_btn btn-sm"><?php echo e(__('Active')); ?></a>
            <?php endif; ?>
            <button class="user-btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                ...
                <span><?php echo e(auth()->user()->username2); ?></span>
            </button>
...
<?php /**PATH /home/dotcdafk/public_html/main/resources/views/frontend/default/layout/auth.blade.php ENDPATH**/ ?>