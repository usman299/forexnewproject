            ...
            <div class="row gy-4 justify-content-between">
                    ...
                    <div class="sp_footer_item">
                        ...
                        <ul class="sp_footer_menu">
                            <?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('links', [$item->id, Str::slug($item->content->page_title)])); ?>"><?php echo e($item->content->page_title); ?></a>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="sp_footer_item">
                        ...
                        <h5 class="mt-4"><?php echo e(__('Social Links')); ?></h5>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>
                        ...
                        <!-- <?php echo e(Config::config()->copyright); ?> -->
                    </p>
                </div>
            </div>
        </div>
...
<!-- footer section end -->
<?php /**PATH /home/tradwiwy/public_html/main/resources/views/frontend/default/widgets/footer.blade.php ENDPATH**/ ?>