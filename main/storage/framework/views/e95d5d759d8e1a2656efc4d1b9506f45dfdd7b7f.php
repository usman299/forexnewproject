<form action="<?php echo e(route('admin.general.basic')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-4 col-xxl-3 col-lg-4 col-sm-6" style="display: none">
...
<?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/setting/general_setting.blade.php ENDPATH**/ ?>