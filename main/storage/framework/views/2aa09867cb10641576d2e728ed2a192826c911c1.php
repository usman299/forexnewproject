        ...
        $(function() {
            ...
            $('.ranges ul li').each(function(index) {
                $(this).on('click', function() {
                    ...
                    $("#overlay").fadeIn(300);
                    $.ajax({
                        url: "<?php echo e(route('admin.deposit.log')); ?>",
                        data: {
                            key: key
                        },
                        method: "GET",
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tradwiwy/public_html/main/resources/views/backend/logs/deposit_log.blade.php ENDPATH**/ ?>