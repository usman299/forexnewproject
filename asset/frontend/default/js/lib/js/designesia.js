 /* --------------------------------------------------
  * © Copyright 2020 - Oleos by Designesia
  * --------------------------------------------------*/
(function($) {
	'use strict';
     ...
     function load_owl() {
		...
		jQuery("#custom-owl-slider").owlCarousel({
         ...
         $(".next").on("click", function() {
             $('#custom-owl-slider').trigger('next.owl.carousel');
         });
         $(".prev").on("click", function() {
             $('#custom-owl-slider').trigger('prev.owl.carousel');
         });
     ...
     jQuery(document).ready(function() {
          ...
          */
          ...
          function doTimer(n){
            v_delay = setTimeout(
                  function() 
                  {
                    jQuery('section').hide();
                    jQuery('header').hide();
                    jQuery('#btn-exit').addClass("clicked");
          ...
          function menu_click(n){
            ...
            if (n.charAt(0) == '#') {
                jQuery('.transition').css('top','100%');
                doTimer(n);
            }
          }

         jQuery(".scrollnav a, .scroll-to").on("click", function(n) {
            menu_click(jQuery(this).attr('href'));
         });
        ...
        jQuery('section:not(#section-main)').hide();
         });
     });
 })(jQuery);